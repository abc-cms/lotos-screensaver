...
public:
    ...
    int run() {
        m_configuration = configuration_t::load("/home/user/development/ls/config/config.json");
        ...
        //m_timer_id = SDL_AddTimer(
        //    33,
        //    &renderer_t::timer_callback,
        //    &m_timer_event
        //);
...
private:
    ...
    void redraw_window_frame() {
        ...
        mpv_render_param params[] = {
            {MPV_RENDER_PARAM_SW_SIZE, window_rect},
    ...
    void redraw_button_frame() {
        ...
        SDL_Color bg_color{
            static_cast<uint8_t>(bg_color_raw & 0xff),
            static_cast<uint8_t>((bg_color_raw >> 8) & 0xff),
        ...
        SDL_Color fg_color{
            static_cast<uint8_t>(fg_color_raw & 0xff),
            static_cast<uint8_t>((fg_color_raw >> 8) & 0xff),
            static_cast<uint8_t>((fg_color_raw >> 16) & 0xff),
            static_cast<uint8_t>((fg_color_raw >> 24) & 0xff)
        };
        m_button_renderer.render(
            button_configuration.text(),
            right - left,
            bottom - top,
            bg_color,
            fg_color,
            button_configuration.corner_radius()
        );
